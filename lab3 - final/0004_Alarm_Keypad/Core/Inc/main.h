...
#define KR1_GPIO_Port GPIOC
#define KR3_Pin GPIO_PIN_8
#define KR3_GPIO_Port GPIOA
#define KR2_Pin GPIO_PIN_9
#define KR2_GPIO_Port GPIOA
#define KC3_Pin GPIO_PIN_3
#define KC3_GPIO_Port GPIOB
#define KC1_Pin GPIO_PIN_4
#define KC1_GPIO_Port GPIOB
#define KC2_Pin GPIO_PIN_5
#define KC2_GPIO_Port GPIOB
#define KR0_Pin GPIO_PIN_6
